...
HD_PWD='C:/Users/Administrator/Desktop/FPGA/SparkCameraPlus/project/beta/sparkcamplus/spartan_cam.runs/system_clk_wiz_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_clk_wiz_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_clk_wiz_0_1.tcl
