...
set_property IOSTANDARD LVCMOS33 [get_ports {ardi_io[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ardi_io[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ardi_io[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ardi_io[0]}]
set_property PACKAGE_PIN A3 [get_ports {ardi_io[3]}]
set_property PACKAGE_PIN A4 [get_ports {ardi_io[2]}]
set_property PACKAGE_PIN B5 [get_ports {ardi_io[1]}]
set_property PACKAGE_PIN A5 [get_ports {ardi_io[0]}]
...
#set_property  PACKAGE_PIN H4[ get_ports { clk } ] set_property  PACKAGE_PIN D14[ get_ports { rst_n } ]