...
(* CORE_GENERATION_INFO = "system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=28,numReposBlks=22,numNonXlnxBlks=3,numHierBlks=6,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=5,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=1,da_mb_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "system.hwdef" *) 
module system
   (TMDS_0_clk_n,
    TMDS_0_clk_p,
    TMDS_0_data_n,
  ...
  wire [0:0]data_lp_n_0_1;
  wire [0:0]data_lp_p_0_1;
  wire [1:0]data_rxn_0_1;
  wire [1:0]data_rxp_0_1;
  wire [3:0]digital_recognition_0_digital;
  wire [3:0]lcd_num_0_ardi_io;
  ...
  wire [23:0]rgb_test_0_RGB_render;
  wire [0:0]rgb_test_0_gray_data;
  wire [0:0]rst_clk_wiz_0_200M_bus_struct_reset;
  wire [0:0]rst_clk_wiz_0_200M_interconnect_aresetn;
  ...
  assign ardi_io[3:0] = lcd_num_0_ardi_io;
  ...
  assign data_lp_n_0_1 = data_lp_n_0[0];
  ...
  system_bayer2rgb_0_0 bayer2rgb_0
       (.clk(clk_wiz_1_clk_out1),
        ...
        .hdata(csi2dvp_0_hdata),
        .hsync_in(csi2dvp_0_vid_hsync),
  ...
  system_csi2_d_phy_rx_0_1 csi2_d_phy_rx_0
       (.cl_enable(csi2_d_phy_rx_0_RX_MIPI_PPI_CL_ENABLE),
        ...
        .clk_rxn(clk_rxn_0_1),
        .clk_rxp(clk_rxp_0_1),
        .data_lp_n(data_lp_n_0_1),
        .data_lp_p(data_lp_p_0_1),
        .data_rxn(data_rxn_0_1),
        .data_rxp(data_rxp_0_1),
  ...
  system_csi_to_axis_0_1 csi_to_axis_0
       (.cl_enable(csi2_d_phy_rx_0_RX_MIPI_PPI_CL_ENABLE),
        ...
        .trig_ack(csi_to_axis_0_data_err_ACK),
        .trig_req(csi_to_axis_0_data_err_TRIG));
  system_digital_recognition_0_0 digital_recognition_0
       (.Binary(rgb_test_0_gray_data),
        .VtcHCnt(csi2dvp_0_hdata),
        .VtcVCnt(csi2dvp_0_vdata),
        .digital(digital_recognition_0_digital),
        .pclk(clk_wiz_1_clk_out1));
  system_lcd_num_0_0 lcd_num_0
       (.ardi_io(lcd_num_0_ardi_io),
        .num(digital_recognition_0_digital));
  ...
  system_rgb2dvi_0_1 rgb2dvi_0
       (.PixelClk(clk_wiz_1_clk_out1),
        ...
        .vid_pData(rgb_test_0_RGB_render),
        .vid_pHSync(bayer2rgb_0_hsync_out),
        .vid_pVDE(bayer2rgb_0_de_out),
        .vid_pVSync(bayer2rgb_0_vsync_out));
  system_rgb_test_0_1 rgb_test_0
       (.PClk(clk_wiz_1_clk_out1),
        .RGB24(bayer2rgb_0_data_out),
        .RGB_render(rgb_test_0_RGB_render),
        .VtcHCnt(csi2dvp_0_hdata),
        .VtcVCnt(csi2dvp_0_vdata),
        .gray_data(rgb_test_0_gray_data),
        .num(digital_recognition_0_digital));
...
module system_microblaze_0_axi_periph_0
  ...
  wire m02_couplers_to_microblaze_0_axi_periph_ARBURST;
  wire m02_couplers_to_microblaze_0_axi_periph_ARCACHE;
  wire m02_couplers_to_microblaze_0_axi_periph_ARLEN;
  wire m02_couplers_to_microblaze_0_axi_periph_ARLOCK;
  wire m02_couplers_to_microblaze_0_axi_periph_ARPROT;
  wire m02_couplers_to_microblaze_0_axi_periph_ARQOS;
  wire m02_couplers_to_microblaze_0_axi_periph_ARREADY;
  wire m02_couplers_to_microblaze_0_axi_periph_ARREGION;
  wire m02_couplers_to_microblaze_0_axi_periph_ARSIZE;
  wire m02_couplers_to_microblaze_0_axi_periph_ARVALID;
  wire m02_couplers_to_microblaze_0_axi_periph_AWADDR;
  wire m02_couplers_to_microblaze_0_axi_periph_AWBURST;
  wire m02_couplers_to_microblaze_0_axi_periph_AWCACHE;
  wire m02_couplers_to_microblaze_0_axi_periph_AWLEN;
  wire m02_couplers_to_microblaze_0_axi_periph_AWLOCK;
  wire m02_couplers_to_microblaze_0_axi_periph_AWPROT;
  wire m02_couplers_to_microblaze_0_axi_periph_AWQOS;
  wire m02_couplers_to_microblaze_0_axi_periph_AWREADY;
  wire m02_couplers_to_microblaze_0_axi_periph_AWREGION;
  wire m02_couplers_to_microblaze_0_axi_periph_AWSIZE;
  ...
  assign M02_AXI_arburst = m02_couplers_to_microblaze_0_axi_periph_ARBURST;
  assign M02_AXI_arcache = m02_couplers_to_microblaze_0_axi_periph_ARCACHE;
  assign M02_AXI_arlen = m02_couplers_to_microblaze_0_axi_periph_ARLEN;
  ...
  assign M02_AXI_arqos = m02_couplers_to_microblaze_0_axi_periph_ARQOS;
  assign M02_AXI_arregion = m02_couplers_to_microblaze_0_axi_periph_ARREGION;
  assign M02_AXI_arsize = m02_couplers_to_microblaze_0_axi_periph_ARSIZE;
  ...
  assign M02_AXI_awburst = m02_couplers_to_microblaze_0_axi_periph_AWBURST;
  assign M02_AXI_awcache = m02_couplers_to_microblaze_0_axi_periph_AWCACHE;
  assign M02_AXI_awlen = m02_couplers_to_microblaze_0_axi_periph_AWLEN;
  ...
  assign M02_AXI_awqos = m02_couplers_to_microblaze_0_axi_periph_AWQOS;
  assign M02_AXI_awregion = m02_couplers_to_microblaze_0_axi_periph_AWREGION;
  assign M02_AXI_awsize = m02_couplers_to_microblaze_0_axi_periph_AWSIZE;
  ...
  m02_couplers_imp_QYRHL1 m02_couplers
       (.M_ACLK(M02_ACLK_1),
        ...
        .M_AXI_arregion(m02_couplers_to_microblaze_0_axi_periph_ARREGION),
        ...
        .M_AXI_awregion(m02_couplers_to_microblaze_0_axi_periph_AWREGION),
