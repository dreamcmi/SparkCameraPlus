...
HD_PWD='C:/Users/Administrator/Desktop/FPGA/SparkCameraPlus/project/beta/sparkcamplus/spartan_cam.runs/system_axi_iic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_iic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_iic_0_0.tcl
